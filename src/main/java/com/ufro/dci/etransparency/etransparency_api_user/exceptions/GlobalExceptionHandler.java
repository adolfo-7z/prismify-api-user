...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<CustomErrorResponse> handleFileSizeExceededException(
        ...
        public ResponseEntity<CustomErrorResponse> handleCustomConversionException(
                        CustomConversionException exception) {
                CustomErrorResponse response = new CustomErrorResponse(exception.getErrorCode(), exception.getMessage(),
